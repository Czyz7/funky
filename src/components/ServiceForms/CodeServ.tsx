            ...
            <div className="flex flex-wrap justify-center mx-auto ">
                <div className="p-2 xl:w-1/4 md:w-1/2 w-full">
                    <div className="h-full p-6 rounded-lg border-2 bg-gray-800 border-gray-300 flex flex-col relative overflow-hidden">
                        ...
                        <h2 className="text-sm tracking-widest title-font mb-1 font-medium text-indigo-50">STARTER SITE</h2>
                        <br>
                        </br>
                        ...
                        <p className="flex items-center text-indigo-50 mb-2">
                            ...
                            </span>Front-End Development (HTML, CSS, JavaScript): Build the visual and interactive aspects of a website.
                        ...
                        <p className="flex items-center text-indigo-50 mb-2">
                            ...
                            </span>Basic Back-End Functionality (Node.js or your preferred language): Implement essential features like forms, user logins (if needed), and a simple database.
                        </p>
                        <br>
                        </br>
                        <p className="flex items-center text-indigo-50 mb-6">
                            ...
                            </span>Responsive Design: Ensure the website functions seamlessly across devices.
                        </p>
                ...
                <div className="p-2 xl:w-1/4 md:w-1/2 w-full">
                    <div className="h-full p-6 rounded-lg border-2 border-gray-300 bg-gray-800 flex flex-col relative overflow-hidden">
                        ...
                        <h2 className="text-sm tracking-widest title-font mb-1 font-medium text-indigo-50">GROWING BOOST</h2>
                        <br>
                        </br>
