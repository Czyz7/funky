                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="w-full md:w-3/5 mb-8 md:mb-0">
                            <h1 className="text-3xl text-white font-bold h-48 text-center">Clear Pricing. Powerful Results.</h1>

                            <p className="text-l text-center h-6 text-indigo-50 mb-4">We offer straightforward pricing for our AI-driven solutions. </p>

                            <p className="text-l text-center h-6 text-indigo-50 mb-4">Minimize guesswork and maximize the return on your investment.</p>

                            <p className="text-l text-center h-28 text-indigo-50 mb-4">Experience the difference of AI-powered services without complex pricing.</p>
                        ...
                        <div className="w-full md:w-2/5">
                            <Image src="/Hero Images/price0.png" alt="Hero serve" width={512} height={512} className="hero-serve" />
                        </div>
                    </div>
                </div>
            </div>
