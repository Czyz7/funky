            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="w-full md:w-3/5 mb-8 md:mb-0">
                        <h1 className="text-2xl font-bold mb-4 text-center">AI Powered Solutions. Better Results. Faster.</h1>

                        <p className="text-l mb-4">Elevate your online presence with cutting-edge AI technology.</p>

                        <p className="text-l mb-4">We optimize your website&#39;s development, content, and strategy.</p>

                        <p className="text-l mb-4">Delivering measurable success at unparalleled speed.</p>
                    ...
                    <div className="w-full md:w-2/5">
                        <Image src="/webManage.png" alt="Hero serve" width={512} height={512} className="hero-serve" />
                    </div>
                </div>
            </div>
        </section>
