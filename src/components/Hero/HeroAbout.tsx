                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="w-full md:w-3/5 mb-8 md:mb-0">
                            <h1 className="text-3xl text-white font-bold h-48 text-center">Improving the Digital Landscape with AI</h1>

                            <p className="text-l text-center h-6 text-indigo-50 mb-4">We actively use the power of AI to revolutionize web development and management</p>

                            <p className="text-l text-center h-6 text-indigo-50 mb-4">Our tools streamline website creation, content generation, site management and SEO.</p>

                            <p className="text-l text-center h-28 text-indigo-50 mb-4">Experience higher quality results, faster than ever before.</p>
