...
const ConsultFaq2 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">I&lsquo;m struggling with low website traffic. Can your consulting help?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    Absolutely!  We utilize AI-powered SEO analysis to uncover hidden issues affecting your rankings. We&lsquo;ll develop a detailed plan to improve your content, target the right keywords, and boost your search visibility.
                </div>
            </div>
        </div>
    )
