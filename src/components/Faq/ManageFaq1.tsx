...
const ManageFaq1 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold"> What is Conversion Rate Optimization (CRO)?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    CRO involves data-driven testing (A/B tests) of website elements like headlines, calls to action, and layouts.  AI guides us in making changes that lead to more visitors taking your desired actions.
                </div>
            </div>
        </div>
    )
