...
const ManageFaq0 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold"> My website is slow. How does an AI-Assisted Performance Analysis help?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    AI allows us to go beyond standard speed tests. We analyze user behavior data and identify hidden bottlenecks that traditional tools miss, leading to targeted optimizations that significantly improve load times.
                </div>
            </div>
        </div>
    )
