...
const SeoFaq1 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">I run an e-commerce store. How does AI improve my product page SEO?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    AI tools, including those from Meta and OpenAI, help us analyze product descriptions, reviews, and search queries. This lets us optimize your product pages with keywords that align with shopper intent and increase the chances of your products appearing in relevant searches.
                </div>
            </div>
        </div>
    )
