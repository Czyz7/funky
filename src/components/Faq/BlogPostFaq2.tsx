...
const BlogPostFaq2 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">How are the images generated, and are they royalty-free?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    We use cutting-edge AI image generation tools like VertexAI, Imagen2, DALL-E 3, to create visuals that complement your blog&#39;s topics.  All images provided will be licensed for commercial use.
                </div>
            </div>
        </div>
    )
