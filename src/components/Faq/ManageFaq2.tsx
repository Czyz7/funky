...
const ManageFaq2 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold"> What&#39;s included in the Content Updates & Edits service?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    We take care of tasks like text revisions, image changes, adding new blog posts, product updates, or other content adjustments as needed.
                </div>
            </div>
        </div>
    )
