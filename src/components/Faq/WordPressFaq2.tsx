...
const WordPressFaq2 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">How does WordPress compare to platforms like Wix?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    WordPress offers greater scalability and flexibility, making it ideal for websites that need room to grow or require complex features. Book a quick consultation with us and we&#39;ll discuss your long-term goals to determine if WordPress is the best fit.
                </div>
            </div>
        </div>
    )
