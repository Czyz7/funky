...
const RedesignFaq1 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold"> How does AI play a role in your website redesign services?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    AI powers several aspects of our process: analyzing user behavior to optimize the new design, generating design concepts for inspiration, and assisting in content refinements for maximum impact.
                </div>
            </div>
        </div>
    )
