...
const WordPressFaq0 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">What is your revision policy?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    The Smart Start package includes 1 revision. The Performance and Growth package includes 2 revisions. The AI Advatage also includes 2 revisions.
                </div>
            </div>
        </div>
    )
