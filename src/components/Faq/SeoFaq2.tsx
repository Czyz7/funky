...
const SeoFaq2 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">Why choose AI-powered SEO over a traditional SEO service?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    AI allows us to process vast amounts of data, gain insights, and optimize your strategy more efficiently and effectively than manual approaches. This translates into faster results and a competitive edge in the search results.
                </div>
            </div>
        </div>
    )
