...
const WixFaq1 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">How does Wix compare to WordPress?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    Wix excels in ease of use and requires less technical maintenance, while WordPress offers greater flexibility for highly complex websites. We&#39;ll help you determine the best platform based on your specific needs and goals.
                </div>
            </div>
        </div>
    )
