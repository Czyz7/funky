...
const WixFaq0 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">I&#39;m not very tech-savvy. Is Wix easy to update after you build it?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    One of Wix&#39;s greatest strengths is its user-friendliness. We&#39;ll provide you with brief training to help you confidently make basic updates to your website after launch.
                </div>
            </div>
        </div>
    )
