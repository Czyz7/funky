...
const SeoFaq0 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">How does AI help you analyze my website&lsquo;s technical SEO?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    We use AI-powered tools from Google, VertexAI, and others to conduct in-depth site audits. AI flags even complex technical issues regarding indexation, speed, mobile-friendliness, and structured data – ensuring your site meets search engine standards.
                </div>
            </div>
        </div>
    )
