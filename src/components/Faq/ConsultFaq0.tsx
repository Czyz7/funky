...
const ConsultFaq0 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">Do you charge by the hour? I dont need a full hour of Consulting time.</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    To be respectful of your time and ours, we charge by 15 minute increments ($75 per 15 minute increment). While your scheduled appointment, please provide all necessary information before checkout.
                </div>
            </div>
        </div>
    )
