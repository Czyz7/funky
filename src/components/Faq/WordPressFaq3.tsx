...
const WordPressFaq3 = () => {
    ...
    return (
        <div className="px-5 md:px-10 lg:px-6 py-8 rounded-3xl bg-gray-800">
            ...
            >
                <span className="text-indigo-50 dark:text-indigo-50 text-3xl font-bold">How does AI help you create better website designs?</span>
            ...
            >
                <div className="overflow-hidden text-xl px-24">
                    AI allows us to rapidly explore design variations, analyze what resonates most with your target audience, and optimize your website&#39;s layout to guide visitors towards your desired actions.
                </div>
            </div>
        </div>
    )
